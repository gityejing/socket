...
//        int candidate = Integer.parseInt(args[2]); // 0 <= candidate <= 1000 req'd
        ...
        InetAddress destAddr = InetAddress.getLocalHost(); // Destination addr
        int destPort = Integer.parseInt("12345"); // Destination port
        int candidate = Integer.parseInt("888"); // 0 <= candidate <= 1000 req'd
